...
const Body = () => {
  ...
  const handleSearch = (event) => {
    ...
    const filtered = resList.filter((restaurant) =>
      restaurant.data.name.toLowerCase().includes(query)
    );
  ...
  return (
    <>
      <div
        ...
        time="40"
        imageLogo="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/e0vvulfbahjxjz6k4uwi"
      >
        <div
        ...
        >
          ...
          <button
            className="filter-btn"
            onClick={() => {
              let filteredRes = resList.filter((res) => res.data.avgRating > 4);
        ...
        <div
          className="resCardContainer"
          time="40"
          imageLogo="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/e0vvulfbahjxjz6k4uwi"
        >
          {resListState.map((data) => (
            <RestrauntCard key={data.data.id} resData={data}></RestrauntCard>
          ))}
        </div>
      </div>
    </>
